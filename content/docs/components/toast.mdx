...
<div className="flex flex-col md:flex-row items-center justify-end gap-2 mb-2">
  <CopyCommandButton
    copyCommand="pnpm dlx shadcn@latest add design-ui/toast"
    command="pnpm dlx shadcn@latest add design-ui/toast"
  />
</div>
...
Bolt Design Toast is using Sonner under the hood. Add the Sonner Toaster component to your layout:
