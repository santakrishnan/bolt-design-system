...
Check the diff against the "main" branch including staged, unstaged, untracked and committed code, and remove all AI generated slop introduced in this branch.
